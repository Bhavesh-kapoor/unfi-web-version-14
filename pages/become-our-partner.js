...
const dealership = () => {
  ...
  return (
    <div className="relative">
      <Head>
        <title>Become Our Partner for Used Car Dealership- Unifi Cars</title>
        <meta
          name="description"
          content="Become our partner for second hand car dealership in just simple steps with minimal charges.Enter few basics details to start your dealership journey with us."
        />
        <meta
          name="keywords"
          content="used car dealership, become our partner, dealer onboarding, become our channel partner"
        />
        <meta
          name="robots"
          content="follow, index, max-snippet:-1, max-video-preview:-1, max-image-preview:large"
        />
        <link rel="canonical" href="https://unificars.com/become-our-partner" />
      </Head>
